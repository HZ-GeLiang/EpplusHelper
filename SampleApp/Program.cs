...
namespace SampleApp
{
    ...
    class Program
    {
        static void Main(string[] args1)
        {
            ...
            //new SampleApp._03读取excel内容.Sample01().Run();
            //new SampleApp._03读取excel内容.Sample02().Run();
            //new SampleApp._03读取excel内容.Sample03().Run();
            //new SampleApp._03读取excel内容.Sample04().Run();
            //new SampleApp._03读取excel内容.Sample05().Run();
            //new SampleApp._03读取excel内容.Sample06().Run();
            //new SampleApp._03读取excel内容.Sample07().Run();
            //new SampleApp._03读取excel内容.Sample08().Run();
            //new SampleApp._03读取excel内容.Sample09().Run();
            //new SampleApp._03读取excel内容.Sample10().Run();
            //new SampleApp._03读取excel内容.Sample11().Run();
            //new SampleApp._03读取excel内容.Sample12().Run();

            //_04填充数据与数据源同步-未测试完全,部分可用,不推荐使用.
            //new SampleApp._04填充数据与数据源同步.Sample01().Run();
            //new SampleApp._04填充数据与数据源同步.Sample02().Run();
            //new SampleApp._04填充数据与数据源同步.Sample03().Run();

            //new SampleApp._05自动初始化填充配置.Sample01().Run();
            //new SampleApp._05自动初始化填充配置.Sample02().Run();
            //new SampleApp._05自动初始化填充配置.Sample03().Run();
