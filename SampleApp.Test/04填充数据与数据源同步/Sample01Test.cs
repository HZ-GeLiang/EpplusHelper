...
namespace SampleApp.Test._04填充数据与数据源同步
{
    ...
    public class Sample01Test
    {
        ...
        {
            SampleApp._04填充数据与数据源同步.Sample01.OpenDir = false;
            SampleApp._04填充数据与数据源同步.Sample01.Run();

            Help.GetExcelFilePath(SampleApp._04填充数据与数据源同步.Sample01.filePathSave, out var runResultFilePath, out var correctResultFilePath);
