...
namespace SampleApp.Test._03读取excel内容
{
    ...
    public class Sample07Test
    {
        ...
        public void 使用内置特性的异常信息()
        {
            ...
            {
                Assert.AreEqual(ex.Message, $@"无效的单元格:C6");
                Assert.AreEqual(ex.InnerException.Message, $@"张三5的性别'其他'填写不正确");
            }
        }
...
resultList.Add(new Sample07.ExcelModel { 序号 = 1, 名字 = "张三1", 性别 = Sample07.Gender.男, 出生日期 = Convert.ToDateTime("1999/9/9"), 身份证号码 = "11111111111111111", 年龄 = 15 });
